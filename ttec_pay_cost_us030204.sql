...
--    SET TIMING ON
    ...
    c_program_name                CUST.ttec_error_handling.program_name%TYPE  := 'ttec_pay_cost_us030204';
    ...
    c_program_name                apps.ttec_error_handling.program_name%TYPE  := 'ttec_pay_cost_us030204';
...
l_module_name              CUST.ttec_error_handling.MODULE_NAME%TYPE := 'get_suspense_acct_id';
...
--dbms_output.put_line(v_person_id); 
  ...
  --************************************************************************************--
    ...
    BEGIN 
			  ...
			  FROM   apps.per_jobs jobs, hr.per_job_definitions jobdef	-- Added code by NXGARIKAPATI-ARGANO, 21/07/2023 
  ...
  --************************************************************************************--
    ...
    BEGIN     
		...
		SELECT payroll_id
        INTO   v_payroll_id
        --FROM   hr.pay_all_payrolls_f	-- Commented code by NXGARIKAPATI-ARGANO, 21/07/2023 
		FROM   apps.pay_all_payrolls_f	-- Added code by NXGARIKAPATI-ARGANO, 21/07/2023 
