...
--    SET TIMING ON
  SET SERVEROUTPUT ON SIZE 1000000;
    ...
    c_interface                   CUST.ttec_error_handling.interface%TYPE := 'CAN_SUP';
    c_program_name                CUST.ttec_error_handling.program_name%TYPE  := 'ttec_can_sup';
    ...
    c_interface                   apps.ttec_error_handling.interface%TYPE := 'CAN_SUP';
    c_program_name                apps.ttec_error_handling.program_name%TYPE  := 'ttec_can_sup';
...
EXCEPTION
     WHEN NO_DATA_FOUND THEN
          ...
          CUST.ttec_process_error(c_application_code, c_interface, c_program_name, l_module_name,
...
--dbms_output.put_line(v_person_id); 
  ...
  --************************************************************************************--
    ...
    --l_module_name      CUST.ttec_error_handling.module_name%TYPE := 'Main Procedure';	-- Commented code by NXGARIKAPATI-ARGANO, 21/07/2023 
	l_module_name      CUST.ttec_error_handling.module_name%TYPE := 'Main Procedure';	-- Added code by NXGARIKAPATI-ARGANO, 21/07/2023 
