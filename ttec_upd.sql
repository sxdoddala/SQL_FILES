...
--    SET TIMING ON
    ...
    c_program_name                CUST.ttec_error_handling.program_name%TYPE  := 'ttec_pay_cost_upd';
    ...
    c_program_name                apps.ttec_error_handling.program_name%TYPE  := 'ttec_pay_cost_upd';
